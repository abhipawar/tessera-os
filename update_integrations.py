...
file_path = "c:\\Users\\abhip\\.gemini\\antigravity\\scratch\\tessera\\tessera-os\\apps\\web\\src\\app\\integrations\\page.tsx"

with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

# Replace Imports
if "Cpu" not in content[:500]:
    content = content.replace("Plug } from 'lucide-react';", "Plug, Cpu } from 'lucide-react';")

# ACTIVE SECTION REPLACEMENT
old_active = """            {/* 1. ACTIVE CONNECTIONS SECTION */}
...
new_active = """            {/* 1. ACTIVE CONNECTIONS SECTION (SPLIT) */}
...
old_catalog = """            {/* 2. GLOBAL CATALOG SECTION */}
...
new_catalog = """            {/* 2. GLOBAL CATALOG SECTION (SPLIT) */}
...
with open(file_path, 'w', encoding='utf-8') as f:
    f.write(content)
print("Finished updates to page.tsx")
