...
import { Network, Server, Code, Workflow, BookOpen, AlertTriangle, Lightbulb, Compass, GitBranch, ArrowRight, CheckCircle2, Shield, TrendingUp, Cpu, Lock, Database } from 'lucide-react';
