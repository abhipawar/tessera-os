...
import { Plug, Cpu, Database, Server, CheckCircle2, XCircle, Loader2, Key, Plus, Lock, Settings } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto space-y-8 relative z-10">
        ...
        {isLoading ? (
          ...
          <div className="space-y-12">
            ...
            {/* 1. ACTIVE CONNECTIONS SECTION (SPLIT) */}
            ...
            {/* 2. GLOBAL CATALOG SECTION (SPLIT) */}
